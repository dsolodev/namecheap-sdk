...
use Namecheap\Api;
/**
 * Namecheap API wrapper - Domain transfer management
 *
 * @author Saddam Hossain <saddamrhossain@gmail.com>
 * @version 2.0
 */
final class DomainsTransfer extends Api
{

    protected string $command = 'namecheap.domains.transfer.';
     ...
     */
    public function getStatus(int $transferId): string|array
    {
     ...
     */
    public function updateStatus(int $transferId, string $resubmit): string|array
    {
